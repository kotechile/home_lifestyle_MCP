"""Configuration loader for the Home & Lifestyle Intelligence MCP system."""
...
def load_config() -> Dict[str, Any]:
    ...
    # Allow environment overrides for database path
    db_path_env = os.environ.get("DB_PATH")
    if db_path_env:
        config.setdefault("storage", {})["db_path"] = db_path_env

    # Ensure DB directory exists
    db_path = Path(config.get("storage", {}).get("db_path", "data/home_intelligence.db"))
